...
function setValidEvents() {
    ...
    // 입력폼 초기화
    document.getElementById('init-form').addEventListener('click', initValidForm);
}
...
async function validate() {
    ...
    if (document.getElementById('addr-num').innerText === '도로명주소 없음') {
        addrLoad = '';
        addrNum = document.getElementById('addr').value;
    } else if (document.getElementById('addr-num').innerText === '지번주소 없음') {
        addrLoad = document.getElementById('addr').value;
        addrNum = '';
    } else {
        addrLoad = document.getElementById('addr').value;
        addrNum = document.getElementById('addr-num').innerText;
    }
