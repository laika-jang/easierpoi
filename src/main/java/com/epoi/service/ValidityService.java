...
public class ValidityService {
    ...
    public Map<String, Object> searchPlace(WebDriver driver, Map<String, String> param, String flag) throws UnsupportedEncodingException {
        ...
        logger.info("ValidityService.searchPlace works. flag: " + flag + ", keywords: " + keywords);
            ...
            do {
                ...
                for (WebElement elem : elemList) {
                    ...
                    if (
                        ...
                        logger.info("find the same place you searched.");
                        samePlace = true;
                        break;
                    }
                ...
                // 다음 페이지 열기
                logger.info("nextPageExist: " + nextPageExist + ", samePlace: " + samePlace);
                if (nextPageExist) {
